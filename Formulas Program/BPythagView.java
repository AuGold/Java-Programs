...
public class BPythagView extends JFrame
{

    private BPythagModel model; //declares the model
    ...
    public BPythagView(BPythagModel m)
	{
		model = m;
	...
	private class SolverListener implements ActionListener
	{
		public void actionPerformed(ActionEvent e)
		{
			...
			double bNum = Math.sqrt(Math.pow(cNum, 2) - Math.pow(aNum, 2));
			bField.setText("" + bNum);
		}
	}
}