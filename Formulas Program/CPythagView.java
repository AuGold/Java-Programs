...
public class CPythagView extends JFrame
{

    private CPythagModel model; //declares the model
    ...
    public CPythagView(CPythagModel m)
	{
		model = m;
	...
	private class SolverListener implements ActionListener
	{
		public void actionPerformed(ActionEvent e)
		{
			...
			double cNum = Math.sqrt(Math.pow(aNum, 2) + Math.pow(bNum, 2));
			cField.setText("" + cNum);
		}
	}
}